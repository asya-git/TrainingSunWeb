            ...
            <nav class="header__nav nav">
                <ul class="nav__menu-list">
                    <li class="nav__menu-item">
                        <a href="#" class="nav__menu-link">Шкафы-купе</a>
                    </li>
                    <li class="nav__menu-item">
                        <a href="#" class="nav__menu-link">Торговая мебель</a>
                    </li>
                    <li class="nav__menu-item">
                        <a href="#" class="nav__menu-link">Кухни</a>
                    </li>
                    <li class="nav__menu-item">
    ...
    <main class="main">
            ...
            <ul class="products__list">
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/types-cuisines/linear.png" alt="пример линейной кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Линейные</h3>
                    <p class="product__description">Такой вид кухни подойдёт в случае, если вам необходимо сэкономить место в помещении</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/types-cuisines/angular.png" alt="пример угловой кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Угловые</h3>
                    <p class="product__description">Угловая кухня позволит увеличить количество отсеков для посуды</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/types-cuisines/insular.png" alt="пример островной кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Островные</h3>
                    <p class="product__description">Остров сочетает в себе систему хранения принадлежностей и обеденную зону</p>
                </li>
            </ul>
        </section>
        <!-- СТИЛИ КУХОНЬ -->
        <section class="products products_pt-80px">
            ...
            <ul class="products__list">
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/kitchen-styles/high-tech.png" alt="пример стиля Хайтек" class="product__img">
                    </div>
                    <h3 class="product__title">Хайтек</h3>
                    <p class="product__description">Данный стиль кухни придаст вашей квартире современный вид</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/kitchen-styles/classic.png" alt="пример стиля Классика" class="product__img">
                    </div>
                    <h3 class="product__title">Классика</h3>
                    <p class="product__description">Классический стиль подойдёт ценителям непревзойдённой мебели прошлых эпох</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/kitchen-styles/neo-classic.png" alt="пример стиля Неоклассика" class="product__img">
                    </div>
                    <h3 class="product__title">Неоклассика</h3>
                    <p class="product__description">Исполнение в стиле неоклассики — смешение античной и современной архитектуры</p>
                </li>
                <li class="products__item product product_big">
                    <div class="product__img-wrapper">
                        <img width="560" height="340" src="img/items-img/kitchen-styles/provence.png" alt="пример стиля Прованс" class="product__img">
                    </div>
                    <h3 class="product__title">Прованс</h3>
                    <p class="product__description">Этот стиль порадует истинного ценителя провинциального французского интерьера, привнеся нотки деревенского шарма, сохранив при этом изящность французского дома</p>
                </li>
                <li class="products__item product product_big">
                    <div class="product__img-wrapper">
                        <img width="560" height="340" src="img/items-img/kitchen-styles/japanese-style.png" alt="пример Японского стиля" class="product__img">
                    </div>
                    <h3 class="product__title">Японский стиль</h3>
                    <p class="product__description">Это разновидность этнических направлений в минимализме, в которой присутствуют безукоризненные цветовые комбинации и лаконичность форм в сочетании с нестандартными решениями в оформлении</p>
                </li>
            </ul>
        </section>
        <!-- ФОРМА -->
        ...
        <section class="products products_pt-160px">
            ...
            <ul class="products__list">
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/material/envelope.png" alt="пример линейной кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Плёнка</h3>
                    <p class="product__description">Данный материал примечателен своей долговечностью, светоустойчивостью, а также огромным многообразием фактур</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/material/wood-shavings.png" alt="пример угловой кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Древесная стружка</h3>
                    <p class="product__description">Фасады из древесной стружки (мелкодисперсная фракция) хороши тем, что их можно отмыть от любой грязи</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/material/shipon.png" alt="пример островной кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Шпон</h3>
                    <p class="product__description">Считается самым дорогостоящим вариантом кухонного гарнитура, так как он получается из ценных древесных пород</p>
                </li>

                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/material/array.png" alt="пример линейной кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Массив</h3>
                    <p class="product__description">Кухня из массива отличается уникальностью и солидностью, а также придаёт помещению благородный внешний вид</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/material/plastic.png" alt="пример угловой кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Пластик</h3>
                    <p class="product__description">Пластик отлично вписывается во все стили дизайна интерьера и позволяет воплотить различные дизайнерские фантазии</p>
                </li>
                <li class="products__item product">
                    <div class="product__img-wrapper">
                        <img width="360" height="230" src="img/items-img/material/enamel.png" alt="пример островной кухни" class="product__img">
                    </div>
                    <h3 class="product__title">Шпон</h3>
                    <p class="product__description">Считается самым дорогостоящим вариантом кухонного гарнитура, так как он получается из ценных древесных пород</p>
                </li>
        ...
        <section class="main__offers offers">
            <h2 class="offers__title title">Что мы предлагаем</h2>
            <ul class="offers__list ">
                <li class="offers__item offer">
                    <svg class="offer__icon" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                    ...
                    <h3 class="offer__title">Сделаем по экскизу</h3>
                    <p class="offer__description">Если у вас есть пожелания, изготовим кухню согласно вашим примерам</p>
                </li>
                <li class="offers__item offer">
                    <svg class="offer__icon" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                        <path d="M54.375 17.3439H48.2812V11.2502C48.2812 10.8772 48.1331 10.5195 47.8694 10.2558C47.6056 9.99207 47.248 9.84391 46.875 9.84391H37.6843C38.3213 7.13372 37.3555 4.03903 35.1341 2.14376C32.6484 0.0235993 29.3822 -0.0906585 26.25 1.78399C23.1179 -0.0910102 19.8516 0.0237164 17.366 2.14376C15.1445 4.03903 14.1788 7.13372 14.8158 9.84391H5.625C5.25204 9.84391 4.89435 9.99207 4.63063 10.2558C4.36691 10.5195 4.21875 10.8772 4.21875 11.2502V50.6252C4.21875 50.9981 4.36691 51.3558 4.63063 51.6195C4.89435 51.8833 5.25204 52.0314 5.625 52.0314H11.7188V58.1252C11.7188 58.4981 11.8669 58.8558 12.1306 59.1195C12.3944 59.3833 12.752 59.5314 13.125 59.5314H54.375C54.748 59.5314 55.1056 59.3833 55.3694 59.1195C55.6331 58.8558 55.7812 58.4981 55.7812 58.1252V18.7502C55.7812 18.3772 55.6331 18.0195 55.3694 17.7558C55.1056 17.4921 54.748 17.3439 54.375 17.3439ZM19.1914 4.28336C19.9283 3.63867 20.875 3.28485 21.8541 3.28821C22.9829 3.28821 24.2051 3.72977 25.4309 4.60821C25.6697 4.77937 25.9562 4.87142 26.25 4.87142C26.5438 4.87142 26.8303 4.77937 27.0691 4.60821C29.3557 2.96946 31.6298 2.8511 33.3086 4.28336C34.9946 5.72172 35.5649 8.20915 34.6351 10.0684C32.8766 13.5855 27.9437 16.3249 26.2492 17.1856C24.5544 16.3266 19.6281 13.5957 17.8649 10.0684C16.9351 8.20879 17.5054 5.72172 19.1914 4.28336ZM7.03125 12.6564H16.1429C19.1898 17.0567 25.3827 19.9011 25.6703 20.0311C25.8525 20.1136 26.0503 20.1563 26.2504 20.1563C26.4504 20.1563 26.6482 20.1136 26.8304 20.0311C27.1174 19.9011 33.3109 17.0567 36.3578 12.6564H45.4688V49.2189H7.03125V12.6564ZM52.9688 56.7189H14.5312V52.0314H46.875C47.248 52.0314 47.6056 51.8833 47.8694 51.6195C48.1331 51.3558 48.2812 50.9981 48.2812 50.6252V20.1564H52.9688V56.7189Z" fill="#F79C1B"></path>
                    ...
                    <h3 class="offer__title">Подстроимся под бюджет</h3>
                    <p class="offer__description">Для эскиза подберем материалы эконом, стандарт или премиум класса</p>
                </li>
                <li class="offers__item offer">
                    <svg class="offer__icon" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                        <path d="M54.375 17.3439H48.2812V11.2502C48.2812 10.8772 48.1331 10.5195 47.8694 10.2558C47.6056 9.99207 47.248 9.84391 46.875 9.84391H37.6843C38.3213 7.13372 37.3555 4.03903 35.1341 2.14376C32.6484 0.0235993 29.3822 -0.0906585 26.25 1.78399C23.1179 -0.0910102 19.8516 0.0237164 17.366 2.14376C15.1445 4.03903 14.1788 7.13372 14.8158 9.84391H5.625C5.25204 9.84391 4.89435 9.99207 4.63063 10.2558C4.36691 10.5195 4.21875 10.8772 4.21875 11.2502V50.6252C4.21875 50.9981 4.36691 51.3558 4.63063 51.6195C4.89435 51.8833 5.25204 52.0314 5.625 52.0314H11.7188V58.1252C11.7188 58.4981 11.8669 58.8558 12.1306 59.1195C12.3944 59.3833 12.752 59.5314 13.125 59.5314H54.375C54.748 59.5314 55.1056 59.3833 55.3694 59.1195C55.6331 58.8558 55.7812 58.4981 55.7812 58.1252V18.7502C55.7812 18.3772 55.6331 18.0195 55.3694 17.7558C55.1056 17.4921 54.748 17.3439 54.375 17.3439ZM19.1914 4.28336C19.9283 3.63867 20.875 3.28485 21.8541 3.28821C22.9829 3.28821 24.2051 3.72977 25.4309 4.60821C25.6697 4.77937 25.9562 4.87142 26.25 4.87142C26.5438 4.87142 26.8303 4.77937 27.0691 4.60821C29.3557 2.96946 31.6298 2.8511 33.3086 4.28336C34.9946 5.72172 35.5649 8.20915 34.6351 10.0684C32.8766 13.5855 27.9437 16.3249 26.2492 17.1856C24.5544 16.3266 19.6281 13.5957 17.8649 10.0684C16.9351 8.20879 17.5054 5.72172 19.1914 4.28336ZM7.03125 12.6564H16.1429C19.1898 17.0567 25.3827 19.9011 25.6703 20.0311C25.8525 20.1136 26.0503 20.1563 26.2504 20.1563C26.4504 20.1563 26.6482 20.1136 26.8304 20.0311C27.1174 19.9011 33.3109 17.0567 36.3578 12.6564H45.4688V49.2189H7.03125V12.6564ZM52.9688 56.7189H14.5312V52.0314H46.875C47.248 52.0314 47.6056 51.8833 47.8694 51.6195C48.1331 51.3558 48.2812 50.9981 48.2812 50.6252V20.1564H52.9688V56.7189Z" fill="#F79C1B"></path>
                    ...
                    <h3 class="offer__title">Гарантия 5 лет</h3>
                    <p class="offer__description">Наша компания занимается изготовлением мебели много лет, мы отвечаем за качество</p>
                </li>
                <li class="offers__item offer">
                    <svg class="offer__icon" xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60" fill="none">
                        <path d="M54.375 17.3439H48.2812V11.2502C48.2812 10.8772 48.1331 10.5195 47.8694 10.2558C47.6056 9.99207 47.248 9.84391 46.875 9.84391H37.6843C38.3213 7.13372 37.3555 4.03903 35.1341 2.14376C32.6484 0.0235993 29.3822 -0.0906585 26.25 1.78399C23.1179 -0.0910102 19.8516 0.0237164 17.366 2.14376C15.1445 4.03903 14.1788 7.13372 14.8158 9.84391H5.625C5.25204 9.84391 4.89435 9.99207 4.63063 10.2558C4.36691 10.5195 4.21875 10.8772 4.21875 11.2502V50.6252C4.21875 50.9981 4.36691 51.3558 4.63063 51.6195C4.89435 51.8833 5.25204 52.0314 5.625 52.0314H11.7188V58.1252C11.7188 58.4981 11.8669 58.8558 12.1306 59.1195C12.3944 59.3833 12.752 59.5314 13.125 59.5314H54.375C54.748 59.5314 55.1056 59.3833 55.3694 59.1195C55.6331 58.8558 55.7812 58.4981 55.7812 58.1252V18.7502C55.7812 18.3772 55.6331 18.0195 55.3694 17.7558C55.1056 17.4921 54.748 17.3439 54.375 17.3439ZM19.1914 4.28336C19.9283 3.63867 20.875 3.28485 21.8541 3.28821C22.9829 3.28821 24.2051 3.72977 25.4309 4.60821C25.6697 4.77937 25.9562 4.87142 26.25 4.87142C26.5438 4.87142 26.8303 4.77937 27.0691 4.60821C29.3557 2.96946 31.6298 2.8511 33.3086 4.28336C34.9946 5.72172 35.5649 8.20915 34.6351 10.0684C32.8766 13.5855 27.9437 16.3249 26.2492 17.1856C24.5544 16.3266 19.6281 13.5957 17.8649 10.0684C16.9351 8.20879 17.5054 5.72172 19.1914 4.28336ZM7.03125 12.6564H16.1429C19.1898 17.0567 25.3827 19.9011 25.6703 20.0311C25.8525 20.1136 26.0503 20.1563 26.2504 20.1563C26.4504 20.1563 26.6482 20.1136 26.8304 20.0311C27.1174 19.9011 33.3109 17.0567 36.3578 12.6564H45.4688V49.2189H7.03125V12.6564ZM52.9688 56.7189H14.5312V52.0314H46.875C47.248 52.0314 47.6056 51.8833 47.8694 51.6195C48.1331 51.3558 48.2812 50.9981 48.2812 50.6252V20.1564H52.9688V56.7189Z" fill="#F79C1B"></path>
                    ...
                    <h3 class="offer__title">Проект на этапе ремонта</h3>
                    <p class="offer__description">Предусмотрим все нюансы и дадим рекомендации по расположению элементов кухни</p>
                </li>
            </ul>
        </section>
    </main>
